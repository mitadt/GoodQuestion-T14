...
<body id="page-top" class="index">
    ...
    <div id="main">
                        ...
                        <input class="form-control" type="text" name="txtName" id="txtName" required>
                        </div>
                        <div class="form-group">
                            <label for="txtcompany">COMPANY NAME:</label>
                            <input class="form-control" type="text" name="txtcompany" id="txtcompany" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="txtdesignation" id="txtdesignation" required>
                        </div>
                        <div class="form-group">
