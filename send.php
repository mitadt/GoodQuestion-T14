   ...
   <div class="container">
    ...
    <div id="main">
        ...
        // }
            ...
            $standard="";
            $contact="";
            $sql="SELECT * FROM sell where id=?" or die($mysqli->error());
                    ...
                    <div id="totalamount">
                        <p class="small">
                            <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                <?php $userID = session_id(); ?>
                                Seller Name:-<?php echo $seller;?><br>
                                Email ID:-<?php echo $email;?><br>
                                Description:-<?php echo $description;?><br>
                                Price:-<?php echo $price;?><br>
                                Standard:-<?php echo $standard;?><br>
