...
<body id="page-top" class="index">
     ...
     <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Registration Page</a>
            </div>
    ...
    <div id="main">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="college" id="college" placeholder="Enter College Name.." required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                                ...
                                <input class="form-control" type="passwords" name="passwords" id="password" Placeholder="Password.." required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qualification" id="qualification" placeholder="Enter Qualification.." required>
                        </div>
                        <div class="form-group">
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $check=mysqli_query($conn,"SELECT * from registration where email='$email' or contact='$contact'"); 
            ...
            {
            $sql=" INSERT INTO registration (name,college,email,passwords,qualification,contact)
                    VALUES ('$name','$college','$email','$passwords','$qualification','$contact')";
